...
@Injectable()
export class TechQueueCustomersService {
  constructor(
  ...
  public async findAll(queue_id: string): Promise<QueueCustomerResponseDto[]> {
  ...
  public async remove(queue_id: string, customer_id: string): Promise<void> {
